...
/***/ function(module, exports, __webpack_require__) {
	...
	var PiggyBank = __webpack_require__(159);

	window.onload = function () {
	  ReactDOM.render(React.createElement(PiggyBank, { title: 'Alan\'s Money Pig', owner: 'Alan', depositAmount: 0.5 }), document.getElementById('app'));
	};
	...
	var PiggyBank = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { type: "button", onClick: this.addToSavings },
	        "Deposit change!"
	      ),
	      React.createElement(
	        "button",
	        { type: "button", onClick: this.withdrawMoney },
	        "Buy sweets!"
	      )
	    );
	  }
